...
export function UserProfileDropdown() {
  ...
  const [uploadImage, setUploadImage] = React.useState(Image)
    ...
    <Dropdown drop="down" alignRight data-tut="my_profile">
      ...
      <Dropdown.Menu className="p-0 m-0 dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl dropdown-user-menu">
        <>
          ...
          {!layoutProps.light && (
            ...
            >
              ...
              <div className="col-md-6 nopaddingl">
                <label>Image</label>
                <input
                  type="file"
                  id="uploadFile"
        ...
        <div className="navi navi-spacer-x-0 pt-5">
          {/* <Dropdown.Item  to="#" className="navi-item px-8 cursor-pointer">
          ...
          <Dropdown.Item className="navi-item px-8 cursor-pointer">
            <Link to="/changeP">
              <div className="navi-link">
                ...
                <div className="navi-text">
                  <div className="font-weight-bold cursor-pointer">{t("Change_Password")}</div>
                </div>
              </div>
            </Link>
          </Dropdown.Item>
        ...
        {/* <div className="navi navi-spacer-x-0 pt-5">
          ...
          <Link to="/changeP" className="navi-item px-8 cursor-pointer">
            <div className="navi-link">
              <div className="navi-icon mr-2">
                <i className="flaticon2-calendar-3 text-success" />
              </div>
