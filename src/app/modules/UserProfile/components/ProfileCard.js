            ...
            <div className="card-body pt-4">
              ...
              <div className="d-flex align-items-center">
                <div className="symbol symbol-60 symbol-xxl-100 mr-5 align-self-start align-self-xxl-center my-profile-img">
                  ...
                  // style={{ backgroundImage: `url(${user.ImageURL ? user.ImageURL : profileImg})` }}
                  >
                    <img src={pic} alt="" id="img" className="img" style={{ width: "100px", height: "100px", borderRadius: 6 }} />

                  </div>
                  {/* style="background-i
                  mage:url('/theme/html/demo1/dist/assets/media/users/300_21.jpg')" */}
              ...
              <div className="py-9 account-info">
                ...
                {/* <div className="d-flex align-items-center justify-content-between">
                  <span className="font-weight-bold mr-2 account-label">Location:</span>
                  <span className="text-muted account-value">{user.Address}</span>
                </div> */}
              </div>
              {/* end::Contact */}
              {/* begin::Nav */}
                  ...
                  >
                    <span className="navi-icon mr-2">
                      <span className="svg-icon">
                        <SVG
                          src={toAbsoluteUrl(
                            "/media/svg/icons/General/tickets.svg"
                          )}
                        ></SVG>{" "}
                      </span>
                    </span>
