...
import { get_countries, get_state, get_city, update_profile, update_profile_img } from "../Auth/_redux/authCrud";
...
export function PersonaInformation(props) {
  // img crop  code
  ...
  const getdata = async () => {
    await get_countries().then(val2 => {
      setcountry_N_code(val2.data); console.log("val2", val2.data);
    }).catch(err => { console.log("error", err) });
  };

  const getstate = async (value) => {
    await get_state(value).then(val2 => {
      setstatename(val2.data); console.log("state dat", val2.data);
    }).catch(err => { console.log("error", err) });
  };

  const getcity = async (value) => {
    await get_city(value).then(val2 => {
      setcityname(val2.data); console.log("city dat", val2.data);
    }).catch(err => { console.log("error", err) });
  }

  const dropdown = (value) => {
    console.log("value of country", value);
    if (localStorage.getItem("countryname2") && value != localStorage.getItem("countryname2")) {
  ...
  const dropdown2 = (value) => {
    ...
    if (localStorage.getItem("statename2") && value != localStorage.getItem("statename2")) {
  ...
  const handleClickOpens = () => {
    ...
    var file = new File([croppedImage], img[0].name, { lastModified: img[0].lastModified, path: 'ppp', preview: 'preview' });
    console.log("file2", file);

    let objs = img;
    objs[0].preview = croppedImage;
    console.log("img", img);
  ...
  const date_for_validation = current_date.getFullYear() - 10 + '-' + (current_date.getMonth() + 1) + '-' + (current_date.getMonth() + 1);
  ...
  const Schema = Yup.object().shape({
    ...
    phone: Yup.string().required("Phone is required").min(10, " Mobile number should have 10 digits").matches(/^[0-9\b]+$/, 'invalid mobile number !')
    ...
    country_code: Yup.string()
      .required("Required").test("not blank", "select country code", value => { return value != '' }),

    country: Yup.string()
      .required("Required").test("not blank", "select country", value => { return value != 'country' }),

    state: Yup.string()
      .required("Required").test("not blank", "select state", value => { return value != '' }),

    city: Yup.string()
      .required("Required").test("not blank", "select city", value => { return value != '' }),
  ...
  const Update_profile_img2 = (obj) => {
    ...
    update_profile_img(obj).then(pre => { console.log("img upload success"); img_upload_success(); }).catch(error => { console.log("error img upload failed", error) });
  ...
  return (
    <div className="my-account-wrapper">
      ...
      >
        ...
        <div className="form">
          <div>
            <Dialog onClose={handleClose} aria-labelledby="customized-dialog-title" open={open} className="uplaod-profile ">
          ...
          <Dialog onClose={handleCloses} aria-labelledby="customized-dialog-title" open={opens} className="success-popup">
            ...
            <DialogContent dividers className="text-center p-10">
              ...
              <p className="success-text mb-10">Your profile image successfully uploaded!</p>
              <button
                type="submit"
            ...
            <div className="form-group row">
              ...
              <div className="col-lg-3 col-xl-3">
                <div className="left-side">
                  ...
                  >
                    ...
                    <img src={pic} alt="" id="img" className="img" style={{ width: "120px", height: "120px", borderRadius: 60 }} />
              ...
              <div className="col-lg-9 col-xl-9">
                <div className="row">
                  <div className="col-lg-6 col-xl-6 col-sm-6">
                    <div className="form-group">
                      <TextField
                        label="First Name"
                        type="text"
                        className={`f-15 ${getInputClasses(
                          "firstname"
                        )}`}
                        name="firstname"
                    ...
                    <div className="d-flex ">
                      ...
                      <div className="form-group number-wrap">
                        <TextField
                          ...
                          className={`text-muted f-15 ${getInputClasses(
                            "phone"
                          )}`}
                  ...
                  <div className="col-lg-12 col-xl-12">
                    <div className="form-group">
                      <TextField
                        ...
                        className={`f-15 address ${getInputClasses(
                          "address"
                        )}`}
                  ...
                  <div className="col">
                    <button type="submit" className="btn btn-primary save-btn" disabled={
                      formik.isSubmitting ||
                      !formik.isValid
      ...
      <img src={croppedImage} alt="Cropped" style={{ width: '150px', height: "150px" }} />
